...
Optional activate this additional VS Code extensions within [devcontainer](https://github.com/draschke/vsc-sap-hana-mta-dev-env-node16x/blob/main/.devcontainer/devcontainer.json).
